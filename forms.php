...
<div class="hero">
   ...
   <!-- <img src="background.jpg" alt="" class="bg-cover"> -->
        <div class="form-box">
    ...
    <form id="register" class="input-group" name="form-register" action="connection_db.php" method="POST">
